package com.example.laser.utils.bluetooth;
...
import com.example.laser.ui.BluetoothActivity;
...
public class ChatService {
    ...
    private void connectionFailed(){
        ...
        Bundle bundle=new Bundle();
        bundle.putString(BluetoothActivity.TOAST,"链接不到设备");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private void connectionLost(){
        ...
        Message msg = mHandler.obtainMessage(BluetoothActivity.MESSAGE_TOAST);
        Bundle bundle=new Bundle();
        bundle.putString(BluetoothActivity.TOAST,"设备链接中断");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private class ConnectedThread extends Thread{
        ...
        public void write(byte[]buffer){
            ...
            mHandler.obtainMessage(BluetoothActivity.MESSAGE_WRITE,buffer).sendToTarget();
        }
