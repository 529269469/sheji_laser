 ...
 */
public class SerialGpioK7Manager {
    private static final String TAG = "SerialGpioManager";

    private SerialGpioK7ReadThread mReadThread;
    private OutputStream mOutputStream;
    private HandlerThread mWriteThread;
    private Scheduler mSendScheduler;

    private static class InstanceHolder {
        public static SerialGpioK7Manager sManager = new SerialGpioK7Manager();
    }
    public static SerialGpioK7Manager instance() {
        return InstanceHolder.sManager;
    }

    private SerialPort mSerialPort;

    private SerialGpioK7Manager() {
    }
    ...
    public SerialPort open(String devicePath, String baudrateString) {
        ...
        try {
            ...
            mReadThread = new SerialGpioK7ReadThread(mSerialPort.getInputStream());
            mReadThread.start();
...
//        RxLogTool.i("发送命令：" + command);
        ...
        rxSendData(bytes).subscribeOn(mSendScheduler).subscribe(new Observer<Object>() {
            ...
            public void onNext(Object o) {
                Log.e(TAG, "onNext: 1111" );
                MainActivity.isGpioK7Read=false;
            }
