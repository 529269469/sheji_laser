 ...
 */
public class SerialGunReadThread extends Thread {
    private static final String TAG = "SerialGunReadThread";
    private BufferedInputStream mInputStream;
    private String type = "D01";

    public SerialGunReadThread(InputStream is) {
