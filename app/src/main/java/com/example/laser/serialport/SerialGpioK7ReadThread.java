 ...
 */
public class SerialGpioK7ReadThread extends Thread {
    private static final String TAG = "SerialGpioK7ReadThread";
    private BufferedInputStream mInputStream;
    private String type = "G02";

    public SerialGpioK7ReadThread(InputStream is) {
