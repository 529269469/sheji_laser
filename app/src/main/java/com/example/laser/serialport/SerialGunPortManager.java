 ...
 */
public class SerialGunPortManager {
    private static final String TAG = "SerialGunPortManager";

    private SerialGunReadThread mReadThread;
    private OutputStream mOutputStream;
    private HandlerThread mWriteThread;
    private Scheduler mSendScheduler;

    private static class InstanceHolder {
        public static SerialGunPortManager sManager = new SerialGunPortManager();
    }
    public static SerialGunPortManager instance() {
        return InstanceHolder.sManager;
    }

    private SerialPort mSerialPort;

    private SerialGunPortManager() {
    }
...
//            }
            ...
            mReadThread = new SerialGunReadThread(mSerialPort.getInputStream());
            mReadThread.start();
